...
def create_argparser():
    ...
    parser.add_argument(
        ...
        choices=("canny", "openpose", "depth", "hed", "hough", "tile", "garment"),
...
def main(args):
    ...
    if args.use_local_model:
        state_dict = torch.load(args.local_model_path, weights_only=True)
        xflux_pipeline.model.load_state_dict(state_dict)
